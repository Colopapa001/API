...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const loadActivity = async () => {
      ...
      // Productos publicados por este usuario (API + memoria)
      const apiProducts = await getProductsByUser(user.id);
      const inMemoryProducts = getUserProducts();
      const published = apiProducts.length + inMemoryProducts.length;
