...
export const validateProductData = (data) => {
  ...
  if (data.stock === undefined || data.stock === null || isNaN(data.stock)) {
    errors.stock = 'El stock es obligatorio y debe ser un número';
  ...
  // Validar imágenes si es requerido
...
export const getStockStatus = (stock) => {
  if (stock === 0) return { status: 'out', text: 'Sin stock' };
  if (stock < 5) return { status: 'low', text: '¡Últimas unidades!' };
